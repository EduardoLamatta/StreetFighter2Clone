...
public class VozRFinal : MonoBehaviour
{

    private AudioSource audioSource;

    public AudioClip audioROUND, audioFinal, audioFight; //Hace referencia a las palabras que se dicen al inicio de cada round
    ...
    void Update()
    {
        ...
        if (inicioCombate.inicioLucha && inicioCombate.mostrarR3)
        {
            animator.SetBool("VozRoundFinal", true);
        ...
        {
            animator.SetBool("VozRoundFinal", false);
